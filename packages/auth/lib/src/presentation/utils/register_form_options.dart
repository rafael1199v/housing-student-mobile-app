...
String genderLabel(AuthLocalizations l10n, String value) => switch (value) {
      'Male' => l10n.genderMale,
      'Female' => l10n.genderFemale,
      _ => l10n.genderOther,
    };

String nationalityLabel(AuthLocalizations l10n, String value) => switch (value) {
...
List<AppDropdownItem<String>> genderOptions(AuthLocalizations l10n) => [
      for (final value in kGenderValues)
        AppDropdownItem(value: value, label: genderLabel(l10n, value)),
    ];

List<AppDropdownItem<String>> nationalityOptions(AuthLocalizations l10n) => [
